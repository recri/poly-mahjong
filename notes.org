...
[ ] enable menu items
	enable them on/off according to state of game
...
[ ] make the icons correct
	in the desktop manifest etc
[ ] saved to desktop game app cannot start new game without menu
	should be better now
[ ] eliminate the play/tiles/layout/scores/prefs menu, just the play
